...
class DocumentReleased {
    ...
    #initGrid() {
        ...
        this.#gridMain.setHeader("No,Document Code, Document Name, Author, Effective Date, Periodic Review, Document Type, View Link, Soft File, Training Record, Remark,");
        this.#gridMain.setInitWidths("50,150,200,100,150,150,200,70,70,70,*,100");
        this.#gridMain.setColumnMinWidth("50,150,200,100,150,150,200,70,70,70,100,100");
        
        this.#gridMain.setColAlign("center,center,center,center,center,center,center,center,center,center,center,center");
        this.#gridMain.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
        this.#gridMain.setColSorting("int,str,str,str,str,str,str,str,str,str,str,str");
        ...
        data.json().then(e => {
            if (e.OK) e.Result.forEach((r, i) => {
                this.#gridMain.addRow(i + 1, [
                    ...
                    r.Remark,
                    "<button class='btn btn-primary btn-sm' onClick='window.open(\"/DocumentControl/DocumentDetailReleased?D=" + r.DocumentCode + "\")'>View Detail</button>"
                ])
            })
        });
    }
...
$(async () => {
    const main = new DocumentReleased();
    main.initial();
})